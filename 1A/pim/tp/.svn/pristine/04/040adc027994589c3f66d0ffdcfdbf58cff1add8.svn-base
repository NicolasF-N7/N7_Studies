...
procedure Exemples_Memoire_Dynamique is
	...
	begin
		...
		Put_Line ("Ptr1.all = " & Integer'Image (Ptr1.all)); -- invalid read
		Put_Line ("Ptr2.all = " & Integer'Image (Ptr2.all)); -- invalid read
		...
		-- XXX Quelle est la valeur de Ptr2.all ? : Valeur quelconque (0)
		--Put_Line ("Ptr2.all = " & Integer'Image (Ptr2.all)); -- invalid read

		--Ptr2 := new Integer;
		--Ptr2.all := 7;--invalid write
		--Put_Line ("Ptr2.all = " & Integer'Image (Ptr2.all)); -- invalid read
		--pragma Assert (Ptr2.all = 7);--invalid read
