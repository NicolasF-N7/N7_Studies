...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_ensembles_sujet_tableau" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#fe285e9c#;
   pragma Export (C, u00001, "test_ensembles_sujet_tableauB");
   ...
   u00134 : constant Version_32 := 16#9113178f#;
   pragma Export (C, u00134, "ensembles_chainageB");
   u00135 : constant Version_32 := 16#8276b8ef#;
   ...
   --  test_ensembles_sujet_tableau%b
