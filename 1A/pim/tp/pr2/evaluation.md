...
# Spécification du module ensemble (5 pt) : 3
...
+---------------------------+-----+-----+-----+-----+-----+-----+-----++-----+-----+-----+-----+-----+-----+
| Paramètres mal décrits    | .5  |     Paramtre non expliqus       ||  Paramtre non expliqus    |     |
+---------------------------+-----+-----+-----+-----+-----+-----+-----++-----+-----+-----+-----+-----+-----+
| Erreur sur précondition   | .5  |     |     |     |     | X   |     ||     |     |     |  X  |  X  |     |
+---------------------------+-----+-----+-----+-----+-----+-----+-----++-----+-----+-----+-----+-----+-----+
...
+ Il ne faut pas utiliser de Return (ni exit sauf Répéter) dans une boucle
+ SP « est présent » ou « supprimer » : ne doit pas parcourir tous les éléments
* SP « supprimer » : maladroit d'utiliser « est présent » puis de chercher l'élement (2 parcours)
...
* Maladresses dans l'implantation du programme Nombre_Moyen_Tirages (.25 par item)
    - Erreur sur le calcul de la moyenne (conversion après la division entière, etc.)
