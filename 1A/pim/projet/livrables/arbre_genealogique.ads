...
package Arbre_Genealogique is
    ...
    --renvoie une liste constitué des ancetres du noeud
    function Ancetres(Arbre: in T_Arbre_Genealogique; Noeud: in Integer) return Liste_Entier.T_Liste;
    
    --Renvoie la liste des ancetres de noeud situé à la generation N
    ...
    procedure Afficher_A_Partire_Noeud(Arbre: in out T_Arbre_Genealogique; Noeud : in Integer);
