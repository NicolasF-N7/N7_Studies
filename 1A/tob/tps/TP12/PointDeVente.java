...
public class PointDeVente {
	...
	public int getPrix(Carburant carburant, LocalDateTime date) {
		NavigableMap<LocalDateTime, Integer> prixDateCarburant = prix.get(carburant);
		if(prixDateCarburant == null) {
			return 0;
		}
		else {
			Map.Entry<LocalDateTime, Integer> mapEntry = prixDateCarburant.floorEntry(date);
			if(mapEntry == null) {
				return 0;
			}
