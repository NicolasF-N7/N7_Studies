...
activite : ACTIVITY IDENTIFIER contraintes { (print_endline "activite : activity IDENTIFIER contraintes") }
        | ACTIVITY IDENTIFIER composite contraintes

composite : LEFT_BRACE elementsSansR RIGHT_BRACE

elementsSansR : |elementsSansR elementsSansR
elementSansR : activite
...
contrainte : action IF IDENTIFIER etat { (print_endline "contrainte : action if IDENTIFIER etat") }
                |REQUIRES NUMBER IDENTIFIER { (print_endline "contrainte : requires NUMBER IDENTIFIER") }
