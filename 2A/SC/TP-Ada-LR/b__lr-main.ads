...
package ada_main is
   ...
   u00379 : constant Version_32 := 16#f5ce72bd#;
   pragma Export (C, u00379, "lr__synchroB");
   u00380 : constant Version_32 := 16#6f87cbb4#;
   pragma Export (C, u00380, "lr__synchroS");
   u00381 : constant Version_32 := 16#32ccec3e#;
   pragma Export (C, u00381, "lr__synchro__automfifoB");
   u00382 : constant Version_32 := 16#40022eb7#;
   pragma Export (C, u00382, "lr__synchro__automfifoS");
   ...
   --  lr%s
   --  lr.synchro%s
   --  lr.synchro.automfifo%s
   --  lr.synchro%b
   --  lr.synchro.automfifo%b
   --  pango%s
   --  pango.enums%s
   --  pango.enums%b
   --  pango.attributes%s
