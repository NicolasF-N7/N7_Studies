 ...
 *******************************************************************************/
package fr.n7.simplepdl.terminaison.main;
...
public class ToLTL extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/fr/n7/simplepdl/terminaison/main/toLTL";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        /*if (!isInWorkspace(simplepdlres.SimplepdlresPackage.class)) {
            // The normal package registration if your metamodel is in a plugin.
        	resourceSet.getPackageRegistry().put(simplepdlres.SimplepdlresPackage.eINSTANCE.eNS_URI, simplepdlres.SimplepdlresPackage.eINSTANCE);
        }*/
        if (!isInWorkspace(simplepdl.SimplepdlPackage.class)) {
            // The normal package registration if your metamodel is in a plugin.
        	resourceSet.getPackageRegistry().put(simplepdl.SimplepdlPackage.eINSTANCE.eNS_URI, simplepdl.SimplepdlPackage.eINSTANCE);
        }
