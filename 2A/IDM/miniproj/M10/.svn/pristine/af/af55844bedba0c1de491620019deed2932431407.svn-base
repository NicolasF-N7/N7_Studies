...
public class ToTina extends AbstractAcceleoGenerator {
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(petrinet.PetrinetPackage.class)) {
            resourceSet.getPackageRegistry().put(petrinet.PetrinetPackage.eINSTANCE.getNsURI(), petrinet.PetrinetPackage.eINSTANCE);
        }
